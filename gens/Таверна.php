...
10 Жареный крокодил с пюре шиповника/Медовуха из росянки",
        'Город'=>"1 Тушёная говядина с грушами и имбирём/Огненный хмельной мёд
...
10  Жареная антилопа с салатом из корнеплодов/Медовуха «Серебряная луна»",
        'Арктика'=>"1 Мускусный суп из буйвола с толокнянкой/«Особый олений бочонок»
...
10 Пирог с водяникой с копчёной лосятиной/Сок можжевельника",
        'Побережье'=>"1 Жареная курица с тимьяном/«Бочонок Кореллона»
...
10 Пряный жареный койот с цветами/Ликёр из кейсии",
        'Холмы'=>"1 Жареный буйвол и шалфеевый хлеб/Бренди «Охотник на бизонов»
...
10 Копчёный лосось с дикими ягодами/Самогонка на лосиных рогах",
        'Луг'=>"1 Картофельное пюре с корицей/Кофе
...
10 Овсянка с мясом ящериц и ореховым хлебом/Чай с папайей",
        'Лес'=>"1 Суп из желудей/«Медовая медовуха»
...
$result = 'Имя: '.getTathernName()."\n";
$result .= 'Хозяин: '.$gender.' '.$race.'. Возраст: '.$ages[$race].'. Имя: '.$owner_name."\n";
$result .= 'Атмосфера: '.$atm."\n";
$result .= 'Комнат: '.$peop[0].'| Слуг: '.$peop[1]."\n";
$result .= 'Сегодня в меню: '.getMenu($location)."\n";
$result .= 'Количество народа: '.$num[0].'('.$num[1].')'."\n";
$result .= 'Тип посетителей: '.peopleType($room)."\n";
$result .= 'Что обсуждают: '.themes()."\n";
$result .= 'Что происходит: '.random_event();
echo  trim($result);